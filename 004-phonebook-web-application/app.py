...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://adasda:adasd32141@sm16qwdpq610d1x.c7s3y2m1dquv.us-west-2.rds.amazonaws.com:3306/phone_book'
...
def init_phone_book_db():
    ...
    db.session.execute(phone_book_table)
